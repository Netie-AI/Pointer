...
3. **Coordinator `127.0.0.1:18010`.** Public Worker is pages only.
   `/workspace` Run refuses (P-06). P-05 parked.
4. **EPIC-P04 and EPIC-P07 remain open.** No GPLv3 dump. Do not merge
...
- P-08 remaining rust (UIA, STT, type). OpenVault custody TBD.
