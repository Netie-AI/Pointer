...
test("teach assist emits POINT tokens from measured controls only", () => {
  ...
  assert.match(main, /overlay.html/);
  assert.match(main, /"host", "overlay.html"/);
  ...
  assert.match(teachOverlay, /leftPct: 12/);
  ...
  assert.match(teachOverlay, /inboxSaved/);
  assert.match(teachOverlay, /Saved on This computer/);
  ...
  assert.match(teachOverlay, /filedEl\.hidden = false/);
...
test("desk chips ask, never act", () => {
  ...
  assert.match(hostApp, /demoFrameTeach/);
  assert.match(hostApp, /Draw a larger BOX \(0\.4%\)/);
  assert.match(hostApp, /Walk is full - 8 boxes/);
  assert.match(hostApp, /Drew a BOX/);
  ...
  assert.match(hostApp, /demoInboxSaved/);
  assert.match(hostApp, /Saved on This computer/);
  ...
  assert.match(hostApp, /stayOnTeachMap/);
  assert.match(hostApp, /#stage \.teach-map/);
  ...
  assert.match(hostApp, /isDemoCatalog\(\) && demoInboxSaved\(\)/);
