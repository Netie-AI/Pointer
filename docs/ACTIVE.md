...
| Coworker desks | `electron/netie/coworker-desks.js` (`teach` measured POINT, `meeting` Heard names/dates/amounts, `today` `document` `security`; meeting spawn files inbox+Word drafts, never Act) |
