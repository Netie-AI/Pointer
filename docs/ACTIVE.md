...
| Dictation / Scribe | `electron/netie/dictate.js`, `scribe.js`, `delivery.js`, `holdkey.js`, `pending-scribe.js` |
| Meeting assist | `electron/netie/meeting.js`; HUD Suggest/Recap/Follow-ups; `GET /api/meeting?notes=1` |
