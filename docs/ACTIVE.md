...
| UIA targeting | `electron/netie/uia.js` (Act targeting + teach POINT; TogglePattern `toggle:`/`check:`/`uncheck:`; ExpandCollapsePattern `expand:`/`collapse:`; no invented coords; no cursor warp) |
