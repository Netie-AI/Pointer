...
| UIA targeting | `electron/netie/uia.js` (Act targeting + teach POINT; InvokePattern on `click:`/`invoke:`; TogglePattern `toggle:`/`check:`/`uncheck:`; ExpandCollapsePattern `expand:`/`collapse:`; no invented coords; no cursor warp) |
