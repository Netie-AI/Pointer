...
|------|-------|----------|-----------|------|
| 2026-08-27 | uacc-detectable-hud | UACC, captureVisible, computer.observe, screenshot, clipboard, PATH overlay, BOX overlay, meeting recap, followups, email, actions, pending scribe, retry, computer.act, chain, captureNowForAsk, Scribe, delivery, IBM Plex, DR-0005, privacy chip, session chip | Screenshotable HUD, loopback act+observe, chained local verbs, Ask live crop, Scribe retry/pending dictation, PATH/BOX teach strokes, Cluely recap/follow-ups/email/actions plus live notes API, honest on-device vs off-device privacy chip, OpenWillow session chip | `2026-08-27_uacc-detectable-hud.md` |
