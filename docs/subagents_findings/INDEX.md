...
|------|-------|----------|-----------|------|
| 2026-08-27 | coworker-desks-workspace | desks, today brief, spawn coworker, meeting assist, workspace.exec, DR-0005, Clicky, Cluely, OpenWorker, Computer | Original desks + standing /today brief + fail-closed spawn; no vendored source; exec refused; P-06 parked | `2026-08-27_coworker-desks-workspace.md` |
