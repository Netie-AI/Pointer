...
|------|-------|----------|-----------|------|
| 2026-08-27 | uacc-detectable-hud | UACC, captureVisible, computer.observe, screenshot, clipboard, PATH overlay, meeting recap, followups, computer.act, Scribe, delivery, IBM Plex, DR-0005 | Screenshotable HUD, loopback act+observe (PNG/clipboard), Scribe, PATH strokes, Cluely recap/follow-ups plus live notes API | `2026-08-27_uacc-detectable-hud.md` |
