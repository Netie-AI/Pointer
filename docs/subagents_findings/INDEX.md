...
|------|-------|----------|-----------|------|
| 2026-08-27 | uacc-detectable-hud | UACC, captureVisible, computer.observe, screenshot, clipboard, PATH overlay, computer.act, Scribe, delivery, IBM Plex, DR-0005 | Screenshotable HUD, UACC READ skills, loopback act+observe (PNG/clipboard), remembered-window Scribe, PATH teach strokes | `2026-08-27_uacc-detectable-hud.md` |
