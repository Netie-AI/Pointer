...
|------|-------|----------|-----------|------|
| 2026-08-27 | coworker-desks-workspace | desks, today brief, host Ask bar, workspace open file, meeting chips, workspace.exec, DR-0005, Clicky, Cluely, OpenWorker, Computer | Original desks + Ask bar; open workspace file is the working set for Review/mail/Word; no vendored source; exec refused; P-06 parked | `2026-08-27_coworker-desks-workspace.md` |
