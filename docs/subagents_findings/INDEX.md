...
|------|-------|----------|-----------|------|
| 2026-08-27 | coworker-desks-workspace | desks, today brief, host Ask bar, home session theater, today plate, work cards, meeting also avoid, meeting llm enrich 300ms, meeting cue compact morph-hidden, meeting cue you them, meeting cue live captions, teach draw stroke, teach stack boxes, teach overlay click-through, teach overlay got it, teach overlay draw, teach overlay action label, workspace computer dock, workspace.exec, workspace open file, workspace?id=, meeting chips, meeting answer card, teach walk path, DR-0005, Clicky, Cluely, OpenWorker, Computer | Original desks + Ask bar; loopback `/` paints live teach path + meeting card + Today plate + filed work cards; `/teach` freehand stroke stacks BOX steps; overlay Draw + Click/Type in on the current BOX + Back / Got it; meeting cue keeps You/Them + Live system captions + Say this when chrome hides; `/workspace` This computer dock Run always refuses (P-06); no vendored source; P-06 parked | `2026-08-27_coworker-desks-workspace.md` |
