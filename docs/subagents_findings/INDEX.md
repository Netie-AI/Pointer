...
|------|-------|----------|-----------|------|
| 2026-08-27 | coworker-desks-workspace | desks, today brief, host Ask bar, home session theater, today plate, work cards, meeting also avoid, meeting llm enrich 300ms, meeting cue compact morph-hidden, teach drag box, teach stack boxes, teach overlay click-through, teach overlay got it, teach overlay add box, workspace open file, workspace?id=, meeting chips, meeting answer card, teach walk path, workspace.exec, DR-0005, Clicky, Cluely, OpenWorker, Computer | Original desks + Ask bar; loopback `/` paints live teach path + meeting card + Today plate + filed work cards; `/teach` stacks dragged boxes (current hold, later dashed); laptop click-through overlay paints that walk plus fixed Back / Got it and Add box; meeting assist is Say this / Also / Don't say with a 300ms OpenVault refine that fails closed to the heuristic, and the HUD live cue bar keeps that stack when chrome hides; open file grounds Heard facts not talk; no vendored source; exec refused; P-06 parked | `2026-08-27_coworker-desks-workspace.md` |
