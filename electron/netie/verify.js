...
const OBSERVABLE = Object.freeze([
  "click", "doubleclick", "rightclick", "uia_toggle", "uia_expand", "uia_invoke", "uia_select", "type", "fill", "drag",
  ...
  "paste", "clipboard_paste", "setvalue", "uia_set", "press", "keypress", "navigate", "open",
  "focus_hwnd",
]);
