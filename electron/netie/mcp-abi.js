...
const CATALOG = Object.freeze([
  ...
  },
  {
    name: "computer.act",
    description:
      "Gated OS actions. instruction plans via recipes then type:/click:/focus:/open:/deliver:/replace:/wait/scroll/doubleclick/rightclick/hover. Clicks and launches need approved true.",
    inputSchema: {
      type: "object",
      properties: {
