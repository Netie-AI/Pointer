  ...
  async perform(action, ctx = {}) {
    ...
    switch (type) {
      ...
      case "uia_invoke": {
        ...
        if (this.dryRun) return { ok: true, type, target, via: "uia-invoke", dryRun: true };
        ...
        return { ok: true, type, target, via: "uia-invoke", name: r.name, keepCursor: true, keepFocus: true };
      }
